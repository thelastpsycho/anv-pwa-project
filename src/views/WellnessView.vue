          ...
          >
            ...
            >
              ...
              <div class="p-6">
                ...
                <template v-else>
                  <h3
                    class="text-xl font-medium text-anvaya-blue dark:text-anvaya-light mb-4"
                  >
                    {{ service.title }}
                  </h3>
                </template>
                ...
                <div class="space-y-4 text-gray-600 dark:text-gray-400">
                  <template v-if="service.additionalInfo">
                    <p
                      ...
                      :key="index"
                      class="italic text-anvaya-blue dark:text-anvaya-light"
                    >
                      {{ info }}
                    </p>
                  </template>
